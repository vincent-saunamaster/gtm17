...
public class ServicesTest {
	...
	public void testSupprimerPlacement() {
		Services test = new Services();
		Patrimoine ref1 = new Patrimoine();
		Patrimoine ref2= new Patrimoine();
		Collection<Placement> colref1 = new ArrayList<Placement>();
		colref1.add(referencePlacementUn);
		ref1.setPlacements(colref1);
		System.out.println(ref1.getPlacements().toString());
		Collection<Placement> colref2 = new ArrayList<Placement>();
		ref2.setPlacements(colref2);
		test.supprimerPlacement(referencePlacementUn);
		System.out.println(ref1.getPlacements().toString());
		System.out.println(ref2.getPlacements().toString());
		Assert.assertEquals(ref1.getPlacements().toString(),ref2.getPlacements().toString());
	}

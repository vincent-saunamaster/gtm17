 ...
 */
@WebServlet("/ServletListerClient") // URL d'accès à cette Servlet (après URL
									// tomcat)
public class ServletListerClient extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 4 - envoi
		request.getRequestDispatcher("/resultatListerClient.jsp").forward(request, response);
		;

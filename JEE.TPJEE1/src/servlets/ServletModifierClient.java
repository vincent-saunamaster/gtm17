 ...
 */
@WebServlet("/ServletModifierClient") // URL d'accès à cette Servlet (après URL
										// tomcat)
public class ServletModifierClient extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ic.modifierClient(id,nom,prenom,couleuryeux,age);
		...
		// 4 - envoi
		request.getRequestDispatcher("/resultatModifierClient.jsp").forward(request, response);
		;
